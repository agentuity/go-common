...
type SessionHelloResponse struct {
	...
	TunnelAddress     string                 `protobuf:"bytes,14,opt,name=tunnel_address,json=tunnelAddress,proto3" json:"tunnel_address,omitempty"`               // Direct address for opening tunnel (data-plane) connections.
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *SessionHelloResponse) GetTunnelAddress() string {
	if x != nil {
...
// SecretRule defines how a secret environment variable is injected into
// outbound HTTP requests by the transparent proxy. The proxy replaces
// hashed placeholder tokens with real secret values in the specified header,
...
const file_gravity_session_proto_rawDesc = "" +
	...
	"\x0etunnel_address\x18\x0e \x01(\tR\rtunnelAddress\"-\n" +
	...
	"\adnsname\x18\x04 \x01(\tR\adnsname\"r\n" +
